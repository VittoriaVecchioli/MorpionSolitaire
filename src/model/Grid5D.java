...
/**
* The Grid5D class inherit the functions from the abstract class Grid 
...
public class Grid5D extends Grid{
	 ...
	 * A point satisfies the conditions if: it is already created and it is not already attached to another point horizontally, 
	...
	/**
	 * This method does the same as searchH but for diagonal down lines
	 * @param row, col
	 */
	...
	/**
	 * This method does the same as searchH but for diagonal up lines
	 * @param row, col
	 */
